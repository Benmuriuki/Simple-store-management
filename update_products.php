...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background-image: url('images/bg-form.jpg'); /* Replace 'your-background-image.jpg' with the actual image URL */
    ...
    <div style='display: flex; flex-wrap: wrap; justify-content: center;'>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<button class='view-details-btn'>View Product Details</button>";
                echo "<a href='update.php?product_id=" . $row["id"] . "' class='edit-btn'>Edit</a>";
                echo "</div>";
            }
        } else {
